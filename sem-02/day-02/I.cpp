...
void print(int i, int j, int k, int l, int m, string &str1, string &str2, string &str3, string &str4, string &str5)
{
    ...
    if (str1[i] == str2[j] and str1[i] == str3[k] and str1[i] == str4[l] and str1[i] == str5[m])
    {
        ...
        print(i + 1, j + 1, k + 1, l + 1, m + 1, str1, str2, str3, str4, str5);
    }
    else
    {
        int a = f(i + 1, j, k, l, m, str1, str2, str3, str4, str5);
        ...
        if (z == a)
        {
            print(i + 1, j, k, l, m, str1, str2, str3, str4, str5);
        }
        else if (z == b)
        {
            print(i, j + 1, k, l, m, str1, str2, str3, str4, str5);
        }
        else if (z == c)
        {
            print(i, j, k + 1, l, m, str1, str2, str3, str4, str5);
        }
        else if (z == d)
        {
            print(i, j, k, l + 1, m, str1, str2, str3, str4, str5);
        }
        else
        {
            print(i, j, k, l, m + 1, str1, str2, str3, str4, str5);
        }
    }
    return;
}
...
int main()
{
    ...
    f(0, 0, 0, 0, 0, s1, s2, s3, s4, s5);
    print(0, 0, 0, 0, 0, s1, s2, s3, s4, s5);
    cout << str;
    return 0;
}